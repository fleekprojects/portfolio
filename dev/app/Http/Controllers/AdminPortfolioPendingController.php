<?php namespace App\Http\Controllers;
	...
	class AdminPortfolioPendingController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Thumbnail','name'=>'thumbnail','type'=>'upload','validation'=>"required|image|max:$pthumsize",'width'=>'col-sm-9','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			...
			$this->form[] = ['label'=>'Description','name'=>'description','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-9'];
	    ...
	    */
	    public function hook_query_index(&$query) {
	        $query->where('portfolio.status',0);
