<?php namespace App\Http\Controllers;
	...
	class AdminTagsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Filter","name"=>"is_filter","callback_php"=>'($row->is_filter == "1" ? "Yes" : "No")'];
			...
			$this->form = [];$this->form[] = ['label'=>'Title','name'=>'title','type'=>'text','validation'=>'required|string|min:3|max:70','width'=>'col-sm-9','placeholder'=>'Enter Text Only'];
			$this->form[] = ['label'=>'Slug','name'=>'slug','type'=>'text','width'=>'col-sm-9','placeholder'=>'Leave Empty to generate automatic slug'];
			$this->form[] = ['label'=>'Category','name'=>'category_id','type'=>'select2','validation'=>'integer|min:0','width'=>'col-sm-9','datatable'=>'categories,title','datatable_where'=>'status=1'];
			$this->form[] = ['label'=>'Is Filter','name'=>'is_filter','type'=>'radio','width'=>'col-sm-9','dataenum'=>'1|Yes;0|No','value'=>'0'];
