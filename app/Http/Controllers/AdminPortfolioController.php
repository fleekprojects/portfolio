<?php namespace App\Http\Controllers;
	...
	class AdminPortfolioController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Image','name'=>'image','type'=>'upload','validation'=>'image|max:3000','width'=>'col-sm-9','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP -- Max Image Size: 3000KB'];
